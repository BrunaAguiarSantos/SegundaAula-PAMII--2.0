...
/* Programa que calcula a área dos triângulos -> ISÓCELES, EQUILATERO E ESCALENO*/
fun main(args: Array<String>) {
    println("\nPrograma que calcula a área de triângulos::")
...
fun CalculoTri(a: Double, b: Double): Double {
    ...
    println(
        "\nAntes de tudo, é preciso escolher um triângulo!! Segue o menu com os tipos de triângulos e digite o que deseja calcular::" +
    ...
    if (num == 1.0) {
        ...
        Valorb = readLine()!!.toDoubleOrNull()

        println("Insira o valor da altura do triângulo (h)")
        Valorh = readLine()!!.toDoubleOrNull()

        //Calculo para achar a área do triângulo
        val AreaIsoceles: Double? = (Valorb!!.times(Valorh!!)) / 2
        println("($Valorb cm² * $Valorh cm²)/2 = $AreaIsoceles cm²")
        ...
        //Calculo para achar a área do triângulo
        val AreaEscaleno: Double? = (Valorb!!.times(Valorh!!)) / 2
        println("($Valorb cm² * $Valorh cm²)/2 = $AreaEscaleno cm²")
